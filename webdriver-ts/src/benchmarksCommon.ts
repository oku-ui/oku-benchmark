...
export const cpuBenchmarkInfosArray: Array<CPUBenchmarkInfo> = [
  ...
  },
  {
    ...
    warmupCount: 5,
    description: "updating all 10 rows.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  },
  {
    ...
    warmupCount: 3,
    description: "updating every 2th row for 10 row.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  ...
  },
  {
    ...
    label: "swap rows",
    warmupCount: 5,
    description: "swap 2 rows for table with 10 rows.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  ...
  },
  {
    ...
    warmupCount: 5,
    description: "appending 10 to a table of 10 rows.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  },
  {
    ...
    label: "clear rows",
    warmupCount: 5,
    description: "clearing a table with 10 rows.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
...
export const memBenchmarkInfosArray: Array<MemBenchmarkInfo> = [
  ...
  },
  {
    id: Benchmark._22,
    label: "run memory",
    description: "Memory usage after adding 10 rows.",
    type: BenchmarkType.MEM,
  },
  {
    id: Benchmark._23,
    label: "update every 2th row for 10 rows (5 cycles)",
    description: "Memory usage after clicking update every 2th row 5 times",
    type: BenchmarkType.MEM,
  },
  // {
  //   id: Benchmark._24,
  ...
  {
    id: Benchmark._25,
    label: "creating/clearing 10 rows (5 cycles)",
    description: "Memory usage after creating and clearing 10 rows 5 times",
    type: BenchmarkType.MEM,
  },
  {
    id: Benchmark._26,
    label: "run memory 20",
    description: "Memory usage after adding 20 rows.",
    type: BenchmarkType.MEM,
  },
];
